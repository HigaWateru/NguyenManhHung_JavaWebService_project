...
public class FileController {
    ...
    public ResponseEntity<ApiResponse<FileUploadResponse>> uploadCourtImage(@PathVariable Long courtId,
            @RequestParam("file") MultipartFile file) throws IOException {
        String secureUrl = fileStorageService.uploadCourtImage(courtId, file);
